...
def import_ai_basic_content():
    ...
    # 知识点标题和对应的Markdown文件（适应新的目录结构）
    knowledge_files = {
        "人工智能定义与发展": "01-AI基础概念/01-人工智能定义与发展/人工智能定义与发展.md",
        "机器学习基础": "01-AI基础概念/02-机器学习基础/机器学习基础.md",
        "深度学习基础": "01-AI基础概念/03-深度学习基础/深度学习基础.md",
        "自然语言处理": "01-AI基础概念/04-自然语言处理/自然语言处理.md",
        "计算机视觉": "01-AI基础概念/05-计算机视觉/计算机视觉.md",
        "人工智能伦理与安全": "01-AI基础概念/06-人工智能伦理与安全/人工智能伦理与安全.md"
    }
